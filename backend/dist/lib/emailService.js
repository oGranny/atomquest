...
exports.sendCheckInReminder = exports.sendRejectionEmail = exports.sendApprovalEmail = exports.sendSubmissionEmail = exports.sendEmail = void 0;
...
if (process.env.MAILTRAP_TOKEN) {
    ...
    transporter = nodemailer_1.default.createTransport((0, mailtrap_1.MailtrapTransport)({
...
const sendSubmissionEmail = async (managerEmail, employeeName, sheetId) => {
  ...
  `;
    await (0, exports.sendEmail)(managerEmail, subject, html);
};
exports.sendSubmissionEmail = sendSubmissionEmail;
const sendApprovalEmail = async (employeeEmail, employeeName) => {
...
const sendRejectionEmail = async (employeeEmail, employeeName, revisionComment) => {
